...
process UNICYCLER {
    ...
    output:
    tuple val(meta), path('*.scaffolds.fa'), emit: scaffolds //used to be .gz
    tuple val(meta), path('*.assembly.gfa'), emit: gfa //used to be .gz
    ...
    //Removed: TODO more elegant solution to this to allow nf-core module updates
